...
select o.id id,o.order_id ,o.`status` order_status, o.type order_type, p.descp project_descp, p.price project_price,
p.type project_type, d.driver_name,d.driver_phone,s.company_name 
